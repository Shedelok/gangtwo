...
green background. Each list should take 14% of the entire screen in width. The overall panel with addons should adapt
its width accordingly. The order of the addons is exactly the same as the order they are described in the spec.
