...
28. No yellow chips
29. No orange chips
30. If at least one of the community cards in Round 2 is a J, Q, or K, the following
    ...
    the deck.
31. This challenge adds an extra condition for a successful heist. Before the player
    ...
    chips was correct.
32. If none of the community cards in Round 2 is a J, Q, or K, the following
    ...
    cards from the deck.
33. Decide which of you will share what hand ranking their current hand has
    (pocket cards plus current community cards) with the rest of the players. They
    cannot share further details.
34. Once the pocket cards have been dealt in Round 1, each player says how
    many “face cards” (J, Q, K) they have.
35. Decide which of you will share with everyone how many cards of a specific
    value they have in their hand
36. Decide which of you will take one card from the deck and add it to their hand.
...
37. Once the pocket cards have been dealt in Round 1, each of you chooses one
